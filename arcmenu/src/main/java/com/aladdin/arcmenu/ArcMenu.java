...
//        });
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            fromDegrees = a.getFloat(R.styleable.ArcLayout_fromDegrees, ArcLayout.DEFAULT_FROM_DEGREES);
            toDegrees = a.getFloat(R.styleable.ArcLayout_toDegrees, ArcLayout.DEFAULT_TO_DEGREES);
            mArcLayout.setArc(fromDegrees, toDegrees);

            int defaultChildSize = mArcLayout.getChildSize();
            newChildSize = a.getDimensionPixelSize(R.styleable.ArcLayout_childSize, defaultChildSize);
    ...
    public void setDrgess(float from,float to){
        fromDegrees = from;
        toDegrees = to;
        mArcLayout.setArc(fromDegrees, toDegrees);
    }
    ...
    public void addItem(View item, OnClickListener listener) {
        ...
        item.setAlpha(0);
        final ObjectAnimator anim = ObjectAnimator.ofFloat(item, "alpha", 0.0f,1.0f);
